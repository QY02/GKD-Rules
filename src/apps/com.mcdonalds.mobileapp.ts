      ...
      rules: [
        {
          ...
          action: 'none',
          snapshotUrls: 'https://e.gkd.li/616dfb8c-9634-420f-9535-3383aa008ab9',
        },
        {
          key: 1,
          name: '关闭Bug弹窗',
          ...
          action: 'back',
          snapshotUrls: 'https://e.gkd.li/f192ca3e-53a9-44a5-964d-a6110c2463ae',
        },
      ],
    },
    {
      ...
      rules: [
        {
          ...
          snapshotUrls: 'https://e.gkd.li/1f8fc43a-7e48-45ff-9958-aed51f579de2',
        },
      ],
    },
    {
      ...
      rules: [
        {
          ...
          snapshotUrls: 'https://e.gkd.li/958d6916-934c-4652-8015-dd4235f90916',
        },
      ],
    },
  ],
